...
We provide an example template for initializing a CloudFormation stack, based on pre-backed public AMI, based at the moment on Ubuntu that will:
...
2. Log-in, select a name, possibly an instance class, and do 'Launch Stack'.

> Note, this will incur in billing. Do check the stack page afterward, and delete the non relevant anymore stacks.
